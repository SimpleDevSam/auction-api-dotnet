...
using RockSeatAuction.API.Repositories.DataAccess;
...
{
    options.UseSqlite("Data Source=C:\\Users\\mathe\\OneDrive\\Área de Trabalho\\DevSam\\RockSeatAuction\\leilaoDbNLW.db");
});
